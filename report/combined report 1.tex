...
There has been a steep rise in the development of software and applications aimed at both patients and doctors alike to aid the treatment and diagnosis of patients. Software has been developed to help free up time pressured GP's condensing the vast rapidly increasing quantities of medical research literature and helping to suggest best practice diagnosis pathways. 
...
From this "Cardiac Track" was created, an integrated solution for prolonged up to date hypertension treatment. It consists of two applications which work in tandem, one for the doctor and one for the patient. The later requires the patient to take their blood pressure (BP) at home each day and then enter this reading into the application. If the patients reading breaches the level which is deemed safe, set by the doctors application, both patient and doctor are alerted. (The patient is prompted to make an appointment with their doctors contact details.) On visiting the surgery the second application can be used by the doctor to track how the patient's BP has varied over time, uncertainty of the data which the patient has inputted and finally prescribe a new antihypertensive medication. The same process is then continued, to ensure the patients BP remains below the target level.

The aim is to provide up to date information and treatment for a patient's hypertensive condition, and hence reduce the prevalence of uncontrolled hypertension and so the associated conditions of stroke and ischaemic heart disease.
...
\end{itemize}
>>>>>>> 19495c43655f1bc0990e9809336d4f9fca1a6fb9
...
\centering
\includegraphics[width=0.75\linewidth]{patientUI.png}
...
\includegraphics[scale=0.028]{ipad.png}
...
Linear regression is a set of mathematical operations that creates a line of best fit for a set of scattered data points. Linear regression can either be multivariate linear regression or simple linear regression. 
...
\begin{wrapfigure}{l}{.50\textwidth}
\centering
\includegraphics[scale=0.30]{mainSQL.png}

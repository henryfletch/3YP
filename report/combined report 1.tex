...
\subsubsection{Login page - \textit{Emma Saragossi}}
...
Embedded in the header on all pages is the patient search bar, which allows the doctor to search by patient ID for immediate access to a patient's blood pressure and treatment history. See section \ref{drapp:MF} and fig.\ref{searchbarhtml} for further details. 
